...
if ( function_exists( 'wfLoadExtension' ) ) {
	...
	/* wfWarn(
	  'Deprecated PHP entry point used for MW_EXT_Quote extension. Please use wfLoadExtension instead, ' .
	  'see https://www.mediawiki.org/wiki/Extension_registration for more details.'
	); */

	return;
} else {
	die( 'This version of the MW_EXT_Quote extension requires MediaWiki 1.25+' );
}
